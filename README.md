## Repositório da disciplina Desenvolvimento Desktop SENAC SC 2020/2

#### Projeto COVID

Pequena aplicação de gerenciador de vacinas. Gira em torno de basicamente
três entidades: Usuários, Vacinas e Vacinação.
